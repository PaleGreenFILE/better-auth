...
// // import { passkey } from "better-auth/plugins/passkey"; // Commenté car non disponible // Commenté car non disponible
...
const options = {
  ...
  plugins: [
    ...
    // // passkey() // Commenté car non disponible // Commenté car non disponible,
    genericOAuth({
      config: [
        {
          clientId: "",
